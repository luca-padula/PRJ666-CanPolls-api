                    ...
                    .then(() => {
                        ...
                        if (partyChanged == 1) {
                            finalMessage += ' You have changed your party. A representative from the new party will shortly approve you.' +
                                ' Until then, you will not be able to create any new events.';
                        }
            ...
            .then(() => {
                ...
                if (status == "true") {
                    ...
                    mailText = 'Hello ' + foundUser.firstName + ',\n\n' +
                        ...
                        ' You are now eligible to create Events, but they will have to be "Approved" by the team before they are visbile to others.' +
                        '\n\n' +
                        'All events are monitored by the Administrators. ' +
                        'Note that submitting an event that is deemed as offensive may result in your account being banned from the website.' +
                        '\n\nAll the best,\nCanPolls Team';
                    ...
                    mailText = 'Hello ' + foundUser.firstName + ',\n\n' +
                        ...
                        '\n\n' +
                        'Please send an email at prj666_193a03@myseneca.ca for further details.' +
                        ' Thank you for using CanPolls.' +
                        '\n\nAll the best,\nCanPolls Team';
                }
...
module.exports.sendAdminEventDetails = function (requestingUserId, eventId) {
    ...
    foundUser.then(values => {
        ...
        foundAdmin.then(values => {
            ...
            let mailText = 'Hello ' + values.firstName + ',\n\nA new event request has been created by one of your party supporters.' +
                '\nClick the link below to check out the event. \n' + mailLink + '\n\nYou can go to your profile to Approve or Decline the event.\n\n' +
                'All the best,\nCanPolls Team.';
            let mailData = {
                from: mailService.appFromEmailAddress,
                to: values.email,
                subject: 'PRJ666 CanPolls ' + foundUser.partyAffiliation + ' Party Event Verification',
                text: mailText
            };
